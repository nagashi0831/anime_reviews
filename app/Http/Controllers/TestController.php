...
{   
    public function lineLogin(){
        ...
        $redirect_uri = "&redirect_uri=https://0e5da5d87ed64d95a1733d340b8c8b29.vfs.cloud9.us-east-2.amazonaws.com/login/line/callback";
    ...
    public function getAccessToken($req){
        ...
        $post_data = array(
            ...
            'code' => $req['code'],
            'redirect_uri' => 'https://0e5da5d87ed64d95a1733d340b8c8b29.vfs.cloud9.us-east-2.amazonaws.com/login/line/callback',
